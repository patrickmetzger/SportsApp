...
import { ClockIcon, DocumentCheckIcon, UserIcon, BuildingOfficeIcon } from '@heroicons/react/24/outline';
...
export default function AdminPendingApprovalsList({ pendingAssistants }: AdminPendingApprovalsListProps) {
            ...
            {pendingAssistants.map((assistant) => (
              <tr key={assistant.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4 text-right">
                  <a
                    href={`/admin/pending-approvals/${assistant.id}`}
