...
export default function CertificationUpload({ certificationTypes }: CertificationUploadProps) {
  ...
  const processFile = async (file: File) => {
    ...
    if (file.type.startsWith('image/')) {
      ...
      try {
        ...
        // Don't fail the whole upload if OCR fails
      } finally {
        setOcrProgress(null);
      }
    }
