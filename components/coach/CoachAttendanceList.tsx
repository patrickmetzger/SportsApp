...
interface CoachAttendanceListProps {
  programs: Program[];
  coachId: string;
}

export default function CoachAttendanceList({ programs, coachId }: CoachAttendanceListProps) {
    ...
    return (
      <div className="bg-white rounded-lg shadow p-8 text-center">
        ...
        <p className="text-gray-500">
          You don't have any programs currently in session. Attendance is only available for active programs.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
          ...
          >
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-4 border-t border-gray-100">
                <a
                  href={`/dashboard/coach/attendance/${program.id}`}
                ...
                <a
                  href={`/dashboard/coach/attendance/${program.id}/history`}
                ...
                <a
                  href={`/dashboard/coach/attendance/${program.id}/export`}
                  className="flex items-center justify-center gap-2 px-4 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition text-sm font-medium"
                >
                  <span>📥</span>
                  <span>Export</span>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-gray-600 space-y-1">
          <li>• Take daily attendance for each active program</li>
          <li>• Mark students as Present, Absent, Excused, or Late</li>
          <li>• View attendance history and generate reports</li>
          <li>• Export attendance data for school records integration</li>
        </ul>
      </div>
    </div>
  );
